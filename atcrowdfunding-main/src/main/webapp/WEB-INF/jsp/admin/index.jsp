              ...
              <tbody>
	              <c:forEach items="${page.list}" var="admin">
	                <tr>
	                  ...
	                  <td>${admin.email }</td>
	                  <td>
					      <button type="button" class="btn btn-success btn-xs" onclick="window.location.href='${PATH}/admin/toAssign?adminId=${admin.id}'"><i class=" glyphicon glyphicon-check"></i></button>
